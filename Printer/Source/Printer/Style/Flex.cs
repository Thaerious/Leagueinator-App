...
namespace Leagueinator.Printer.Styles {
    public class Flex : Style {
        ...
        private void DoRootSize(Element element) {
        ...
        /// <summary>
        /// Calculates and assigns page numbers to element elements of a given _parent element based on the 
        /// _parent's content size and the heights of the children. Returns the total page count for 
        /// the _parent element.
        /// </summary>
        /// <param name="element">The _parent element.</param>
