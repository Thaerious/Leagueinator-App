...
namespace Leagueinator.Scoring.Plus {
    ...
    internal class PlusXMLBuilder : IEventXMLBuilder {
        /// <resultsPlus>
        ...
        public Element BuildElement(EventRow eventRow) {
            ...
            List<PlusSummary> summaryList = WTLResultsBuilder.GetResults(eventRow);

            for (int i = 0; i < summaryList.Count; i++) {
                PlusSummary currentResult = summaryList[i];
